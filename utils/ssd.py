...
def SSD300(input_shape, num_classes=21):
    ...
    net['conv1_1'] = Conv2D(64, (3, 3), activation=lrelu(alpha = 1e-5), padding='same', name='conv1_1')(net['input'])
    net['conv1_2'] = Conv2D(64, (3, 3), activation=lrelu(alpha = 1e-5), padding='same', name='conv1_2')(net['conv1_1'])
    net['pool1'] = MaxPooling2D((2, 2), strides=(2, 2), padding='same', name='pool1')(net['conv1_2'])

    # Block 2
    net['conv2_1'] = Conv2D(128, (3, 3), activation=lrelu(alpha = 1e-5), padding='same', name='conv2_1')(net['pool1'])
    net['conv2_2'] = Conv2D(128, (3, 3), activation=lrelu(alpha = 1e-5),  padding='same', name='conv2_2')(net['conv2_1'])
    net['pool2'] = MaxPooling2D((2, 2), strides=(2, 2), padding='same', name='pool2')(net['conv2_2'])

    # Block 3
    net['conv3_1'] = Conv2D(256, (3, 3),  activation=lrelu(alpha = 1e-5), padding='same', name='conv3_1')(net['pool2'])
    net['conv3_2'] = Conv2D(256, (3, 3), activation=lrelu(alpha = 1e-5), padding='same', name='conv3_2')(net['conv3_1'])
    net['conv3_3'] = Conv2D(256, (3, 3), activation=lrelu(alpha = 1e-5), padding='same', name='conv3_3')(net['conv3_2'])
    net['pool3'] = MaxPooling2D((2, 2), strides=(2, 2), padding='same', name='pool3')(net['conv3_3'])

    # Block 4
    net['conv4_1'] = Conv2D(512, (3, 3), activation=lrelu(alpha = 1e-5), padding='same', name='conv4_1')(net['pool3'])
    net['conv4_2'] = Conv2D(512, (3, 3), activation=lrelu(alpha = 1e-5), padding='same', name='conv4_2')(net['conv4_1'])
    net['conv4_3'] = Conv2D(512, (3, 3), activation=lrelu(alpha = 1e-5), padding='same', name='conv4_3')(net['conv4_2'])
    net['pool4'] = MaxPooling2D((2, 2), strides=(2, 2), padding='same', name='pool4')(net['conv4_3'])

    # Block 5
    net['conv5_1'] = Conv2D(512, (3, 3), activation=lrelu(alpha = 1e-5), padding='same', name='conv5_1')(net['pool4'])
    net['conv5_2'] = Conv2D(512, (3, 3), activation=lrelu(alpha = 1e-5), padding='same', name='conv5_2')(net['conv5_1'])
    net['conv5_3'] = Conv2D(512, (3, 3), activation=lrelu(alpha = 1e-5), padding='same', name='conv5_3')(net['conv5_2'])
    net['pool5'] = MaxPooling2D(((3, 3)), strides=(1, 1), padding='same', name='pool5')(net['conv5_3'])

    # FC6
    net['fc6'] = Conv2D(1024, (3, 3), dilation_rate=(6, 6), activation=lrelu(alpha = 1e-5), padding='same', name='fc6')(net['pool5'])
    # x = Dropout(0.5, name='drop6')(x)

    # FC7
    net['fc7'] = Conv2D(1024, (1, 1), activation=lrelu(alpha = 1e-5), padding='same', name='fc7')(net['fc6'])
    # x = Dropout(0.5, name='drop7')(x)

    # Block 6
    net['conv6_1'] = Conv2D(256, (1, 1), activation=lrelu(alpha = 1e-5), padding='same',name='conv6_1')(net['fc7'])
    net['conv6_2'] = Conv2D(512, (3, 3), strides=(2, 2), activation=lrelu(alpha = 1e-5), padding='same', name='conv6_2')(net['conv6_1'])

    # Block 7
    net['conv7_1'] = Conv2D(128, (1, 1), activation=lrelu(alpha = 1e-5), padding='same', name='conv7_1')(net['conv6_2'])
    net['conv7_2'] = ZeroPadding2D()(net['conv7_1'])
    net['conv7_2'] = Conv2D(256, (3, 3), strides=(2, 2), activation=lrelu(alpha = 1e-5), padding='valid', name='conv7_2')(net['conv7_2'])

    # Block 8
    net['conv8_1'] = Conv2D(128, (1, 1), activation=lrelu(alpha = 1e-5), padding='same', name='conv8_1')(net['conv7_2'])
    net['conv8_2'] = Conv2D(256, (3, 3), strides=(2, 2), activation=lrelu(alpha = 1e-5), padding='same', name='conv8_2')(net['conv8_1'])
